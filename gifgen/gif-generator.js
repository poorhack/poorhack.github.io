...
(function () {
    ...
    themeToggle.addEventListener('click', function () {
        ...
        if (current === 'dark') {
            ...
            localStorage.setItem('gif-gen-theme', 'light');
        } else {
            document.documentElement.setAttribute('data-theme', 'dark');
            localStorage.setItem('gif-gen-theme', 'dark');
        }
    });
    ...
    function generateGIF() {
        ...
        var gif = new GIF({
            ...
            height: height,
            repeat: repeatCount,
            workerScript: GIF_WORKER_BLOB_URL,
            transparent: null
        });
